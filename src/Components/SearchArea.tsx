...
export const SearchArea = () => {
  ...
  return (
    <div className="flex flex-col items-center">
        ...
        <div className="flex flex-row items-center justify-center mt-12 gap-8 search-area">
          <p className="text-3xl whitespace-nowrap text-left head">הכנס מספר רכב </p>
          <input placeholder="מספר רכב"className="my-2 rounded-3xl text-2xl text-center text-red-800 w-6/12 p-2 h-10 font-bold" type="search" value={registarationNum} onChange={handleChange} />
